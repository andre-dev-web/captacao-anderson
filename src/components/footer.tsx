      ...
      <div className="bg-orange-400 pt-1 flex items-center">
        <div className="container mx-auto py-2 px-5 flex flex-wrap flex-col sm:flex-row">
          ...
          <span className="inline-flex sm:ml-auto justify-center sm:justify-start">
            <a href="https://www.instagram.com/felipemilhas_/" className="text-white hover:scale-125 transition-all duration-300"  target="_blank">
              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-7 h-7" viewBox="0 0 24 24">
                <FaInstagram/>
              </svg>
            </a>
            <a href="https://www.youtube.com/@turbinandomilhas" className="ml-3 text-white hover:scale-125 transition-all duration-300"  target="_blank">
              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-7 h-7" viewBox="0 0 24 24">
                <FaYoutube/>
              </svg>
            </a>
            <a href="https://www.facebook.com/profile.php?id=100071971836165" className="ml-3 text-white hover:scale-125 transition-all duration-300"  target="_blank">
